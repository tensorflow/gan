...
flags.DEFINE_string(
    "generated_x_dir",
    "/tmp/generated_x/",
    "If image_set_y_glob is defined, where to output the generated X " "images.",
)

flags.DEFINE_string(
    "generated_y_dir",
    "/tmp/generated_y/",
    "If image_set_x_glob is defined, where to output the generated Y " "images.",
)

flags.DEFINE_integer(
    "patch_dim", 128, "The patch size of images that was used in train.py."
)
