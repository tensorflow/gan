...
class CycleganTest(tf.test.TestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        {"kernel_size": 3}, {"kernel_size": 4}, {"kernel_size": 5}, {"kernel_size": 6}
    )
    ...
    @parameterized.parameters({"height": 29}, {"height": 30}, {"height": 31})
    ...
    @parameterized.parameters({"width": 29}, {"width": 30}, {"width": 31})
