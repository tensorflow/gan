...
flags.DEFINE_string(
    "image_set_x_file_pattern", None, "File pattern of images in image set X"
)
flags.DEFINE_string(
    "image_set_y_file_pattern", None, "File pattern of images in image set Y"
)
...
flags.DEFINE_integer(
    "max_number_of_steps", 500000, "The maximum number of gradient steps."
)
flags.DEFINE_integer(
    "ps_replicas",
    0,
...
flags.DEFINE_float(
    "cycle_consistency_loss_weight", 10.0, "The weight of cycle consistency loss"
)
...
def main(_):
    hparams = train_lib.HParams(
        FLAGS.image_set_x_file_pattern,
        FLAGS.image_set_y_file_pattern,
        FLAGS.batch_size,
        FLAGS.patch_size,
        FLAGS.master,
        FLAGS.train_log_dir,
        ...
        FLAGS.ps_replicas,
        FLAGS.task,
        FLAGS.cycle_consistency_loss_weight,
    )
