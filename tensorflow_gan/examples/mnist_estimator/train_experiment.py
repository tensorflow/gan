...
flags.DEFINE_bool(
    "joint_train",
    False,
    "Whether to jointly or sequentially train the generator and " "discriminator.",
)

# ML Infra.
flags.DEFINE_string(
    "model_dir",
    "/tmp/tfgan_logdir/mnist-estimator-tae",
...
flags.DEFINE_integer(
    "num_reader_parallel_calls", 4, "Number of parallel calls in the input dataset."
)
flags.DEFINE_boolean(
    "use_dummy_data", False, "Whether to use fake data. Used for testing."
)
