...
HParams = collections.namedtuple('HParams', [
    ...
    'continuous_noise_dims', 'max_number_of_evaluations', 'write_to_disk'
])
...
def evaluate(hparams, run_eval_loop=True):
  ...
  """
    ...
    tf.compat.v1.summary.image('categorical',
    ...
    tf.compat.v1.summary.image('continuous1',
    ...
    tf.compat.v1.summary.image('continuous2',
