...
flags.DEFINE_integer(
    "stable_stage_num_images", 1000, "Number of images in the stable stage."
)

flags.DEFINE_integer(
    "transition_stage_num_images", 1000, "Number of images in the transition stage."
)

flags.DEFINE_integer("total_num_images", 10000, "Total number of images.")

flags.DEFINE_integer(
    "save_summaries_num_images", 100, "Save summaries in this number of images."
)
...
flags.DEFINE_float(
    "gradient_penalty_target", 1.0, "Gradient norm target for wasserstein loss."
)

flags.DEFINE_float(
    "gradient_penalty_weight", 10.0, "Gradient penalty weight for wasserstein loss."
)

flags.DEFINE_float(
    "real_score_penalty_weight",
    0.001,
...
flags.DEFINE_string(
    "train_log_dir",
    "/tmp/tfgan_logdir/progressive_gan/",
