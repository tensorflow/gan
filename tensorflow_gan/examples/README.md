...
[TF-GAN](https://cs.corp.google.com/piper///depot/google3/third_party/py/tensorflow_gan) is a lightweight library for training and evaluating Generative
...
and include some sample outputs. We've also included a [jupyter notebook](https://cs.corp.google.com/piper///depot/google3/third_party/py/tensorflow/gan/examples/google3_tutorial.ipynb), which
...
1. [StarGAN / StarGAN Estimator](#stargan)
...
network architectures are defined [here](https://cs.corp.google.com/piper///depot/google3/third_party/py/tensorflow_gan/examples/mnist/networks.py).
...
network architectures are defined [here](https://cs.corp.google.com/piper///depot/google3/third_party/py/tensorflow/gan/examples/cifar/networks.py).
...
## StarGAN / StarGAN Estimator
<a id='stargan'></a>

We have a [StarGAN](https://arxiv.org/abs/1711.09020) implementation for multi-domain
image translation, as well as a tf.Estimator implementation.

### Results

We run StarGAN on the [CelebA dataset](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html).

<img src="g3doc/stargan_13k_steps.png" title="StarGAN" width="500" />
