...
flags.DEFINE_string(
    "model_dir",
    "/tmp/tfgan_logdir/sagan-estimator",
...
flags.DEFINE_float("discriminator_lr", 0.0004, "The discriminator learning rate.")
...
flags.DEFINE_enum(
    "mode",
    None,
    ["train", "continuous_eval", "train_and_eval"],
...
flags.DEFINE_integer("max_number_of_steps", 50000, "The maximum number of train steps.")
flags.DEFINE_integer(
...
flags.DEFINE_integer("eval_batch_size", 32, "The number of images in each eval batch.")
flags.DEFINE_integer(
    "predict_batch_size", 80, "The number of images in each predict batch."
)
...
flags.DEFINE_integer(
    ...
    None,
    "None, or number of seconds to wait for a checkpoint " "before stopping.",
)
...
flags.DEFINE_string(
    "gcp_project", None, "Name of the GCP project containing Cloud TPUs."
)
flags.DEFINE_string("tpu_zone", None, "Zone where the TPUs are located.")
flags.DEFINE_integer(
    "tpu_iterations_per_loop",
    1000,
    "Steps per interior TPU loop. Should be less than " "--train_steps_per_eval.",
)
