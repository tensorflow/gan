...
flags.DEFINE_integer('num_steps', 100, 'The number of steps for evaluation.')
flags.DEFINE_integer(
    'num_inception_images', 16,
...
def main(_):
  hparams = eval_lib.HParams(FLAGS.batch_size, FLAGS.hr_dimension, FLAGS.scale,
                             FLAGS.model_dir, FLAGS.data_dir, FLAGS.num_steps,
