...
flags.DEFINE_integer('hr_dimension', 128, 'Dimension of a HR image.')
flags.DEFINE_integer('scale', 4, 'Factor by which LR images are downscaled.')
...
def main(_):
  hparams = train_lib.HParams(
      FLAGS.batch_size, FLAGS.scale, FLAGS.model_dir, FLAGS.phase_1,
      FLAGS.phase_2, FLAGS.hr_dimension, FLAGS.data_dir, FLAGS.print_steps,
      FLAGS.trunk_size, FLAGS.total_steps, FLAGS.decay_steps,
      FLAGS.decay_factor, FLAGS.lr, FLAGS.beta_1, FLAGS.beta_2, FLAGS.init_lr,
      FLAGS.loss_type, FLAGS.lamda_, FLAGS.eta, FLAGS.image_dir)
