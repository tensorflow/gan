...
class EvalTest(tf.test.TestCase, parameterized.TestCase):
  ...
  @parameterized.parameters(
      {'eval_real_images': True, 'conditional_eval': False},
      {'eval_real_images': False, 'conditional_eval': False},
      {'eval_real_images': False, 'conditional_eval': True},
  )
  ...
  def test_build_graph(self, mock_provide_data, mock_iscore, mock_fid,
                       eval_real_images, conditional_eval):
