...
"""Networks for GAN compression example using TF-GAN."""
...
from tensorflow_models.slim.nets import dcgan
...
def _encoder(img_batch, is_training=True, bits=64, depth=64):
  ...
  # TODO(joelshor): Make the DCGAN convolutional layer that converts to logits
