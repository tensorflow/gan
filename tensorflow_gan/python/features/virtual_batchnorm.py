  ...
  """
    ...
    """
        ...
        with tf.compat.v1.variable_scope(
            name, "VBN", values=[reference_batch]
        ) as self._vs:
            ...
            self._example_weight = 1.0 / (tf.cast(ref_batch_size, tf.float32) + 1.0)
            self._ref_weight = 1.0 - self._example_weight
