  ...
  """
    ...
    with tf.compat.v1.variable_scope(name, "spectral_norm"):
        ...
        if replica_context is None:  # cross repica strategy.
            ...
            raise ValueError(
                "spectral norm isn't supported in cross-replica "
...
def spectral_normalize(
    w, power_iteration_rounds=1, equality_constrained=True, training=True, name=None
):
...
def spectral_norm_regularizer(
    scale, power_iteration_rounds=1, training=True, scope=None
):
  ...
  """
    ...
    def sn(weights, name=None):
        ...
        with tf.compat.v1.name_scope(
            scope, "SpectralNormRegularizer", [weights]
        ) as name:
