...
class GroupNormTest(tf.test.TestCase, absltest.TestCase):
    ...
    def testOutputSmallInput4D_NHWC(self):
        ...
        self.doOutputTest(input_shape,
                          ...
                          reduction_axes=[-3, -2])
        # Specify axes with positive values.
        self.doOutputTestForMeanCloseToZero(input_shape,
                                            channels_axis=3,
                                            reduction_axes=[1, 2])
        # Specify axes with negative values.
        self.doOutputTestForMeanCloseToZero(input_shape,
    ...
    def testOutputBigInput4D_NHWC(self):
        self.doOutputTest([5, 100, 100, 1],
                          channels_axis=3,
                          reduction_axes=[1, 2],
                          groups=1)
        self.doOutputTestForMeanCloseToZero([5, 100, 100, 1],
                                            channels_axis=3,
                                            reduction_axes=[1, 2],
                                            groups=1)

    def testOutputBigInput4D_NCHW(self):
        self.doOutputTest([1, 100, 100, 4],
                          channels_axis=1,
                          reduction_axes=[2, 3],
                          groups=4)
        self.doOutputTestForMeanCloseToZero([1, 100, 100, 4],
                                            channels_axis=1,
                                            reduction_axes=[2, 3],
                                            groups=4)
    ...
    def testOutputSmallInput2D_NC(self):
        self.doOutputTest([10, 7 * 100],
                          ...
                          reduction_axes=[],
                          groups=7)
        self.doOutputTestForMeanCloseToZero([10, 7 * 100],
                                            channels_axis=1,
                                            reduction_axes=[],
                                            groups=7)
