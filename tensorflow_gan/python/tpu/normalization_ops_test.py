...
from tensorflow_gan.python.tpu.normalization_ops import (
    accumulated_moments_for_inference,
)
...
class BatchNormTest(tf.test.TestCase, parameterized.TestCase):
    @parameterized.parameters({"conditional": True}, {"conditional": False})
    ...
    @parameterized.parameters({"same_name": True}, {"same_name": False})
...
class MovingMomentsTest(tf.test.TestCase, parameterized.TestCase):
    @parameterized.parameters({"decay": 0.1}, {"decay": 0.999})
